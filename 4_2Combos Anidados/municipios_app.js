...
window.onload = function()
{
    ...
    let eleSelect_Municipios=document.getElementById('municipios');
...
function eventos()
{
    document.getElementById('provincias').addEventListener('change',change_provincia);
    document.getElementById('municipios').addEventListener('change',change_municipio);
}
